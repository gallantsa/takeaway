			...
			<scroll-view style="max-height: 70vh;" scroll-y="true">
				<view style="padding: 40rpx 40rpx 140rpx 40rpx;">
					<view style="text-align: right; margin-bottom: 10rpx; color: #999;" v-if="cartList.length">
						...
						<text style="font-size: 12px;" @click="deleteAll">清空</text>
					</view>
					...
					<view style="margin-top: 10rpx; text-align: right;" v-if="amount.discount">优惠金额：
						<text style="color: red;">-￥{{ amount.discount }}
						</text>
					</view>
					<view style="margin-top: 10rpx; text-align: right;" v-if="amount.actual">实付金额：
						<text style="color: red; font-size: 32rpx;">￥{{ amount.actual }}
						</text>
					</view>
				</view>
			</scroll-view>
