			...
			<uni-forms ref="form" :modelValue="form" :rules="rules" validateTrigger="blur">
				...
				<uni-forms-item>
					<button @click="register()"
						style="background-color: #ffd100; border-color: #ffd100; height: 70rpx; line-height: 70rpx;">注
						册</button>
				</uni-forms-item>
				<uni-forms-item>
					<view style="text-align: right;">已有账号? 去 <navigator
							style="display: inline-block; color: dodgerblue; margin-left: 4rpx;"
							url="/pages/login/login">登录</navigator>
					</view>
				</uni-forms-item>
			</uni-forms>
		</view>
